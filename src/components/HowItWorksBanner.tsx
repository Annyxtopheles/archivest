import bannerImg from "@/assets/StoryGroove_Banner_Image.png";
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 md:px-10">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <blockquote className="mt-8 mx-auto max-w-3xl rounded-xl border-l-4 border-[#36FF9B] bg-[#36FF9B]/10 px-6 py-5 text-left text-lg md:text-xl leading-relaxed text-white italic shadow-[0_10px_30px_rgba(0,0,0,0.2)]">
