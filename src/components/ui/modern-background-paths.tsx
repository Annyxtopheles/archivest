...
interface ModernBackgroundPathsProps {
  className?: string
  children?: React.ReactNode
}

export function ModernBackgroundPaths({
  className,
  children
}: ModernBackgroundPathsProps) {
  ...
  return (
    <div className={cn("relative w-full", className)}>
      ...
      <div className="absolute inset-0 text-[#36FF9B]/40 pointer-events-none">
        <m.div
          key={currentPattern}
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
      ...
      {/* Gradient Overlay */}
      <div className="absolute inset-0 bg-gradient-to-t from-[#0B221B]/40 via-transparent to-[#0B221B]/40" />
