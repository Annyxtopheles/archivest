...
const LiteraryRenaissanceBanner = () => {
  return (
    ...
    >
      <img src={bannerImg} alt="Archivest journal, spectacles, and manuscript" className="absolute inset-0 w-full h-full object-cover" loading="lazy" decoding="async" width={1920} height={600} />
